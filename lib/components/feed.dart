...
class FeedState extends State<SliderExample> {
  ...
  Widget build(BuildContext context) {
    ...
    final recommendationDescription = {
      ...
      "POPULAR":
          "This Post was chosen because it has a lot of likes in our community.",
    ...
    return Scaffold(
        ...
        body: RefreshIndicator(
            onRefresh: update,
            child: buildListView(
                feed, colorMap, format, recommendationDescription)));
  }

  ListView buildListView(List<Post?> feed, Map<String, Color> colorMap,
      DateFormat format, Map<String, String> recommendationDescription) {
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              ClipRRect(
                                  ...
                                  child: Image(
                                      image:
                                          NetworkImage(feed[index]!.imageURl))),
                              Row(
                                mainAxisAlignment:
                                ...
                                children: <Widget>[
                                  Row(
                                    children: [
                                      ...
                                      Text(feed[index]!.likes.toString()),
                                    ],
                                  ),
